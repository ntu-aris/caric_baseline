...
class info_agent{
    public:
        ...
        bool get_leader_position(Eigen::Vector3d& target){
    ...
    public:
        ...
        void Astar_local(Eigen::Vector3d target,string myname,string leader_name,bool &flag,bool islong){
            ...
            if(myname=="/jurong"||myname=="/raffles"){
                if(true){//Here condition should be whether need waiting;
        ...
        // void exploration(string myname){
        //     list<Eigen::Vector3i>path_index_temp;
        //     if(height>=map_shape.z()){
        //         if(!is_finished){
        //             path_index_temp=Dijkstra_search_2D_with_3D(map_shape.z()-1,map_shape.z()-1,myname);
        ...
        //     }else{
        //         // yolo();
        //         path_index_temp=Dijkstra_search_2D_with_3D(height,height+5,myname);
        //         // cout<<"now position:"<<now_position_index.transpose()<<endl;
        //         // for(auto& point:path_index_temp){   
        //         //     cout<<point.transpose()<<endl;
        //         // }
        //         // yolo();
        //         if(path_index_temp.empty()){
        //             cout<<"No path on layer:"<<height<<endl;
        //             height=height+2;
        //             if(height>=map_shape.z()){
        //                 path_index_temp=Dijkstra_search_2D_with_3D(map_shape.z()-1,map_shape.z()-1,myname);
        //             }else{
